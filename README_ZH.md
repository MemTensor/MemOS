...
[文档](https://memos-docs.openmem.net/home/overview/) · [论文](https://arxiv.org/abs/2507.03724) · [Discord](https://discord.gg/Txbx3gebZR) · [X](https://x.com/MemOS_dev) · [Issues](https://github.com/MemTensor/MemOS/issues)
...
> **Docker 提示：** 在 Docker 中运行本地插件时，需设置 `MEMOS_HOME` 环境变量或传入 `--home` 指定配置路径。见 [Docker 部署说明](./apps/memos-local-plugin/README.md#docker-deployment)。
