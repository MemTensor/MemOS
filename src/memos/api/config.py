...
class APIConfig:
    ...
    def get_scheduler_config() -> Dict[str, Any]:
        ...
        return {
            ...
            "config": {
                ...
                "act_mem_update_interval": int(os.getenv("MOS_SCHEDULER_ACT_MEM_UPDATE_INTERVAL", "300")),
                ...
                "thread_pool_max_workers": int(os.getenv("MOS_SCHEDULER_THREAD_POOL_MAX_WORKERS", "10")),
                "consume_interval_seconds": int(os.getenv("MOS_SCHEDULER_CONSUME_INTERVAL_SECONDS", "3")),
                "enable_parallel_dispatch": os.getenv("MOS_SCHEDULER_ENABLE_PARALLEL_DISPATCH", "true").lower() == "true",
            }
        }
    ...
    def get_product_default_config() -> Dict[str, Any]:
        ...
        config = {
            ...
            "chat_model": {
                ...
                "config": openai_config if os.getenv("MOS_CHAT_MODEL_PROVIDER", "openai") == "openai" else qwen_config,
            },
            "mem_reader": {
            ...
            "enable_activation_memory": os.getenv("ENABLE_ACTIVATION_MEMORY", "false").lower() == "true",
            "top_k": int(os.getenv("MOS_TOP_K", "50")),
    ...
    def create_user_config(user_name: str, user_id: str) -> tuple[MOSConfig, GeneralMemCube]:
        ...
        default_cube_config = GeneralMemCubeConfig.model_validate({
                ...
                "config": {
                    ...
                    "graph_db": {
                        ...
                        "config": {
                            ...
                            "db_name": os.getenv("NEO4J_DB_NAME", f"db{user_id.replace('-', '')}"),#, replace with 
            ...
            "act_mem": {} if os.getenv("ENABLE_ACTIVATION_MEMORY", "false").lower() == "false" else APIConfig.get_activation_config(),
            "para_mem": {},
        })
