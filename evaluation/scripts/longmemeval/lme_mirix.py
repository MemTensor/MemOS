...
if __name__ == "__main__":
    ...
    if os.path.exists("./results/lme/mirix_lme_test_result.json"):
        results = [
            json.loads(i) for i in open("./results/lme/mirix_lme_test_result.json", "r").readlines()
        ]
    ...
    def process_one(index):
        ...
        response = assistant.chat(
            f"""You will be given a question and you need to answer the question based on the memories.
