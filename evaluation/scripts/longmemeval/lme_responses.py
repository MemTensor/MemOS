...
def process_qa(user_id, search_result, llm_client):
    ...
    print(f"💬 Answer: \033[96m{anwer[:150]}...\033[0m" if len(anwer) > 150 else f"💬 Answer: \033[96m{anwer}\033[0m")
    print("-"*80)
...
def main(frame, version, num_workers=4):
    print("\n" + "="*80)
    print(f"🚀 \033[1;36mLONGMEMEVAL RESPONSE GENERATION - {frame.upper()} v{version}\033[0m".center(80))
    print("="*80)
    ...
    print(f"🔌 \033[1mUsing OpenAI client with model:\033[0m \033[94m{os.getenv('CHAT_MODEL')}\033[0m")
    ...
    with ThreadPoolExecutor(max_workers=num_workers) as executor:
        ...
        for future in tqdm(as_completed(future_to_user_id), total=len(future_to_user_id), desc="📝 Generating responses"):
    ...
    print("\n" + "="*80)
    print(f"✅ \033[1;32mRESPONSE GENERATION COMPLETE\033[0m".center(80))
    print("="*80)
    ...
    print(f"🔄 \033[1mFramework:\033[0m \033[94m{frame}\033[0m | \033[1mVersion:\033[0m \033[94m{version}\033[0m")
