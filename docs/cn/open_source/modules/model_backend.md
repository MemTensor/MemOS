...
| 工厂类 | 产出 | 典型后端 |
|---------|----------|------------------|
| `LLMFactory` | 对话模型 | `ollama`, `openai`, `azure`, `qwen`, `deepseek`, `atlascloud`, `huggingface`, `huggingface_singleton`, `vllm`, `openai_new` |
...
| `atlascloud` | Atlas Cloud 兼容 OpenAI 的 API | `deepseek-ai/DeepSeek-V3.1` |
